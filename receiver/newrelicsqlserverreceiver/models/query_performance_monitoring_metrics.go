...
// This struct follows nri-mssql's WaitTimeAnalysis model for compatibility
type WaitTimeAnalysis struct {
	QueryID             *string    `db:"query_id" json:"query_id" metric_name:"query_id" source_type:"attribute"`
